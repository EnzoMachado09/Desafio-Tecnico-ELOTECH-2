...
public class RecomendacaoControllerTest {
    ...
    void recomendarLivrosComLivrosDisponiveis() throws Exception {
        ...
        when(recomendacaoService.recomendarLivros(usuario1.getId())).thenReturn(livrosRecomendados);
    ...
    void recomendarLivrosSemLivrosDisponiveis() throws Exception {
        ...
        // Simula o comportamento do serviço
        when(recomendacaoService.recomendarLivros(usuario1.getId())).thenReturn(List.of());
